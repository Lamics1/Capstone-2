...
import com.example.coach_booking_system.Service.TrainingSessionService;
...
public class TrainingSessionController {
    ...
    public ResponseEntity<?> updateSession(@PathVariable Integer id, @Valid @RequestBody TrainingSession session, Errors errors) {
        if (errors.hasErrors()) {
